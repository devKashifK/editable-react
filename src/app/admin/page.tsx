...
export default function Dashboard() {
  ...
  const pagesByCategory = pageConfig?.data?.reduce((acc, page) => {
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-600">Manage and organize your website content</p>
          </div>
              ...
              <div key={category} className="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div className="border-b border-gray-100 bg-gray-50 px-6 py-4">
                  <h2 className="text-xl font-semibold text-gray-800 capitalize flex items-center gap-2">
                    <Icon icon="mdi:folder-outline" className="w-6 h-6 text-blue-500" />
                    {category.replace(/-/g, ' ')}
                    ...
                    {pages.map((page) => (
                      ...
                      >
                        <div className="flex-shrink-0 w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                          <Icon icon="mdi:file-document-outline" className="w-5 h-5 text-blue-500" />
                        </div>
