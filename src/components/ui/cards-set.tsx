...
export const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div dangerouslySetInnerHTML={{ __html: description }}  className="text-md text-neutral-600 text-left dark:text-neutral-300 max-w-max md:max-w-xs  relative z-10 px-4 md:px-10" />
